...
define('TEXT_EXIST_PRODUCTS_PART_COM', 'Existing Part No.s');
define('TEXT_EXIST_PRODUCTS_MODEL_COM', 'Existing Models');

define('TEXT_PRODUCTS_NET_WEIGHT', 'Products Net Weight:');
define('TEXT_PRODUCTS_HANDLE_FEE', 'Products Handle Fee:');
define('TEXT_PRODUCTS_PART_MSG', 'Show Part No. Compatibility?');
define('TEXT_PRODUCTS_MODEL_MSG', 'Show Model Compatibility?');
define('TEXT_PRODUCTS_WARRANTY_MSG', 'Show Warranty Messages?');
define('TEXT_PRODUCTS_DISCLAIMER_MSG', 'Show Disclaimer Messages?');
