...
//删除part
    $sql = "delete from fortech_part where brand_part_id in (select brand_part_id from fortech_brand_part where product_id= " . $product_id . ")";
    $db->Execute($sql);
    $sql = "delete from fortech_brand_part where product_id= " . $product_id;
    $db->Execute($sql);
//删除 model

    $sql = "delete from fortech_model where series_model_id in ( select series_model_id from fortech_series_model where brand_series_id in ( select brand_series_id from fortech_brand_series where product_id=" . $product_id . "))";
    $db->Execute($sql);
    $sql = "delete from fortech_series_model where brand_series_id in (select brand_series_id from fortech_brand_series where product_id=" . $product_id . ")";
    $db->Execute($sql);
    $sql = "delete from fortech_brand_series where product_id=" . $product_id;
    $db->Execute($sql);
