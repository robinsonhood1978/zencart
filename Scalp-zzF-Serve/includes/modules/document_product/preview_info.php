...
//auto replace with defined missing image
        ...
        if ((isset($_POST['image_delete']) && $_POST['image_delete'] == '1') || ($products_image_name == '' && PRODUCTS_IMAGE_NO_IMAGE_STATUS == '1')) {
            ...
            echo zen_image(DIR_WS_CATALOG_IMAGES .'medium/'. $products_image_name, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'class="img-thumbnail" style="float:right;"') . $pInfo->products_description;
        }
        if($products_image_name2 != ''){
            echo zen_image(DIR_WS_CATALOG_IMAGES .'medium/'. $products_image_name2, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'class="img-thumbnail" style="float:right;"') . $pInfo->products_description;
        }
        if($products_image_name3 != ''){
            echo zen_image(DIR_WS_CATALOG_IMAGES .'medium/'. $products_image_name3, $pInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'class="img-thumbnail" style="float:right;"') . $pInfo->products_description;
        }
        ?>
    </div>
    <?php
