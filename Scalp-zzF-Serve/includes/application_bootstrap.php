...
include(DIR_WS_INCLUDES . 'extra_configures/email_use_8bit.php');
include(DIR_WS_INCLUDES . 'extra_configures/enable_error_logging.php');
include(DIR_WS_INCLUDES . 'extra_configures/media_manager.php');
include(DIR_WS_INCLUDES . 'extra_configures/security_patch_v138_20090619.php');
include(DIR_WS_INCLUDES . 'extra_configures/stats_sales_report_graphs.php');
include(DIR_WS_INCLUDES . 'extra_configures/use_catalog_time_zone.php');
/**
 * init some vars
 */
$template_dir = '';
