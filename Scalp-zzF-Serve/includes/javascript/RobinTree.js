    ...
    function(a) {
        ...
        d.prototype.init = function() {
            ...
            g.prototype.toOneHTML = function(a, d) {
                ...
                return f = d ? "<ul class='menuUl'><li style='" + b + "'><button type='button' style='" + e + "' p-id='0' lu-sign='topAdd' lu-type='createChild'>Add New Brand</button></li>" : "<ul class='menuUl'>",
                    g = this,
                    a.map(function(a) {
                        console.log("a.text:"+a.text);
                        f += "<li style='" + b + "'>",
                            f += "leaf" != a.type ? "<i style='" + c + "' p-id='" + a.id + "' lu-sign='" + a.type + "' ischek='false' class='" + g.mouIconClose + "' unLoaded></i>" + "<span p-id='" + a.id + "' lu-sign='" + a.type + "' ischek='false'>" + a.name + "</span>"  : "<i style='" + c + "' p-id='" + a.id + "' class='" + g.simIcon + "'></i>" + "<span p-id='" + a.id + "'>" + a.name + "</span>",
                        f += "0" != a.show ?"<button type='button' style='" + e + "' p-id='" + a.id + "' lu-sign='" + a.type + "' lu-type='createChild'>"+a.text+"</button>":"",
                            f += "<button type='button' style='" + e + "' p-id='" + a.id + "' lu-show='" + a.show + "' lu-sign='" + a.type + "' lu-type='delete'>Delete</button></li>"
                    }),
                    f += "</ul>"
            }
            ,
            ...
            g.prototype.bindEvent = function() {
                ...
                console.log("事件绑定"),
                    ...
                    e.click(function() {
                        var i, j, k, e = a(this), f = e.attr("p-id"), robin_s=e.attr("lu-show"), g = e.attr("lu-type"), h = e.attr("lu-sign");
                        console.log("id:" + f),
                            console.log("type:" + g),
                                    ...
                                    "" == j ? (alert("Please Input Content"),
                                        ...
                                        success: function(a) {
                                            ...
                                            200 == a.code ? "leaf" != h ? (f = a.data,
                                                g = "<li style='" + b + "'>" + "<i style='" + c + "' p-id='" + f.id + "' class='" + d.simIcon + "'></i>" + "<span p-id='" + f.id + "'>" + j + "</span>" ,
                                                g += (f.show==1)?"<button type='button' style='" + i + "' p-id='" + f.id + "' lu-sign='" + f.type + "' lu-type='createChild'>"+f.text+"</button>":"",
                                                g += "<button type='button' style='" + i + "' p-id='" + f.id + "' lu-show='" + f.show + "' lu-sign='" + f.type + "' lu-type='delete'>Delete</button></li>",
            ...
            ,
            a.fn.extend({
                RobinTree: function(b) {
                    return new d(a(this),b)
                },
                RobinAjaxTree: function(b) {
                    return new f(a(this),b)
                },
                RobinUpdateTree: function(b) {
