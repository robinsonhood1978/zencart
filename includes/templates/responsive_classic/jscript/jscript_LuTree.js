    ...
    function(a) {
        ...
        d.prototype.init = function() {
            ...
            f.prototype.toOneHTML = function(a) {
                ...
                return a.map(function(a) {
                    d += "<li style='" + b + "'>",
                        d += "leaf" != a.type ? "<i style='" + c + "' p-id='" + a.id + "' lu-level='"+a.level+"' lu-sign='" + a.type + "' ischek='false' class='" + e.mouIconClose + "' unLoaded></i>" + "<span p-id='" + a.id + "' lu-sign='" + a.type + "' ischek='false'>" + a.name + "</span></li>" : "<i style='" + c + "' p-id='" + a.id + "' class='" + e.simIcon + "'></i>" + "<span p-id='" + a.id + "'>" + a.name + "</span></li>"
                }),
                    d += "</ul>"
            }
            ,
            f.prototype.update = function(b, c, level) {
                var d = this;
            ...
            f.prototype.bindEvent = function() {
                ...
                console.log("事件绑定"),
                    ...
                    this.element.find(".menuUl li i[unLoaded]").click(function() {
                        var c = a(this)
                            , d = c.attr("p-id"), level = c.attr("lu-level");
                        c.attr("loaded", ""),
                            c.removeClass(b.mouIconClose).addClass(b.mouIconOpen),
                            c.attr("ischek", "true"),
                            console.log("触发未加载事件"),
