...
<!--eof Product description -->
    ...
    <?php if ($products_warranty != '') { ?>
        <div id="productWarranty" class="productGeneral biggerText"><?php echo stripslashes($products_warranty); ?></div>
    <?php } ?>
<br/>
    <?php if ($products_part_msg != '') { ?>
        <div id="productPartMsg" class="productGeneral biggerText"><?php echo stripslashes($products_part_msg); ?></div>
    <?php } ?>
    <div class="a" id="ajaxPart"></div>
