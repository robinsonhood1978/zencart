...
//Robin
define('TABLE_PRODUCTS_EXT', DB_PREFIX . 'products_ext');
define('TABLE_TYPE', DB_PREFIX . 'fortech_product_types');
define('TABLE_PRODUCTS_CONDITION', DB_PREFIX . 'fortech_products_condition');
define('TABLE_PRODUCTS_COLOR', DB_PREFIX . 'fortech_pcolors');
define('TABLE_PRODUCTS_EXTRA_MESSAGE', DB_PREFIX . 'fortech_products_extra_messages');
define('TABLE_PRODUCTS_EXTRA_MESSAGE_GROUP', DB_PREFIX . 'products_extra_messages_group');
