...
if ($products_image != '' && $products_image2 != '' && $flag_show_product_info_additional_images != 0) {
    // prepare image name
    ...
    $images_array[] = $products_image;
    if ($products_image2 != ''){
        $images_array[] = $products_image2;
    }
    if ($products_image3 != ''){
        $images_array[] = $products_image3;
    }
   /*
...
if ($num_images > 0) {
    ...
    for ($i=0, $n=$num_images; $i<$n; $i++) {
        $file = $images_array[$i];
        $products_image_large = str_replace(DIR_WS_IMAGES, DIR_WS_IMAGES . 'large/', $products_image_directory) . $file;
//echo $products_image_large."<br>";
        // -----
        ...
        $base_image = $products_image_directory . 'small/'.$file;
