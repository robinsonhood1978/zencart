 ...
 * @version $Id: Scott C Wilson 2020 Apr 02 Modified in v1.5.7 $
 */
/*
...
if (!isset($product_info->EOF, $product_info->fields['products_id'], $product_info->fields['products_status']) || $product_info->fields['products_id'] !== (int)$_GET['products_id']) {
    ...
    $product_ext_info = zen_get_product_ext_details($_GET['products_id']);
}
...
if ($product_not_found) {
    ...
    //Robin
    $type_name= zen_get_products_type_name((int)$_GET['products_id']);
    ...
    $products_part_msg = zen_get_product_extro_msg('p',$product_ext_info->fields['products_show_part']);
    $products_model_msg = zen_get_product_extro_msg('m',$product_ext_info->fields['products_show_model']);
    $products_disclaimer_msg = zen_get_product_extro_msg('d',$product_ext_info->fields['products_show_disclaimer']);
...
// if review must be approved or disabled do not show review
    ...
    $products_image2='';
    if ($product_info->fields['products_image2'] != '') {
        $products_image2 = $product_info->fields['products_image2'];
    }
    $products_image3='';
    if ($product_info->fields['products_image3'] != '') {
        $products_image3 = $product_info->fields['products_image3'];
    }
