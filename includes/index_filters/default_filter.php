...
if (isset($_GET['m_brand']) && $_GET['m_brand'] != '') {
    ...
    if (isset($_GET['series_code']) && $_GET['series_code'] != '') {
        ...
        if (isset($_GET['model_code']) && $_GET['model_code'] != '') {
            ...
            $and .= " and p.products_id in (select product_id from fortech_brand_series a join fortech_series_model b on 
        ...
        $and .= " and p.products_id in (select product_id from fortech_brand_series where brand_name='".$m_brand."')";
    }
...
if (isset($_GET['p_brand']) && $_GET['p_brand'] != '') {
    ...
    if (isset($_GET['part_code']) && $_GET['part_code'] != '') {
        ...
        $and .= " and p.products_id in (select product_id from fortech_brand_part c join fortech_part d on 
            c.brand_part_id=d.brand_part_id where c.brand_name='".$p_brand."' and d.part_code='".$part_code."')";
    }
    else{
        $and .= " and p.products_id in (select product_id from fortech_brand_part where brand_name='".$p_brand."')";
    }
}
