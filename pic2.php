<?php
resizeImage('images/test.jpg','images/test_new.jpg',93,94);

resizeImage('../images/test.jpg','../images/small/test_new.jpg',70,70);
resizeImage('../images/test.jpg','../images/medium/test_new.jpg',200,200);
exit();
/**
* 图片生成缩略图
*
